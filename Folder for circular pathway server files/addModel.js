...
modelType = document.getElementById("type_of_model");
circularModel = document.getElementById("circular_model");
linearModel = document.getElementById("linear_model");
...
// function to deterimine if a user is creating a circular or a linear pathway
function setModelType() {
    if (linearModel.checked) {
        isCircular = false;
        console.log(isCircular);
    }
    // this is if our default linear modeal remains checked even if it is not selected
    else {
        isCircular = true;
        console.log(isCircular);
    }
