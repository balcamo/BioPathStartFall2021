"use strict"
/*
This script edits a model on the view page.
*/
var firstRectMidX;
var firstRectMidY;
...
/*
This function is to allow users to zoom in using their mouse pad by pinching their fingers closer together or farther apart.
- Paramter event: allows an event(action) to be sent in to make sure that the zoom occurs. 
- Returns: nothing
*/
...
function determineCoordinates(currentReaction,numReactions){
    (x + 50 (Math.cos(2(currentReaction)(Math.π)/numReactions)), y + 50 (Math.sin(2(currentReaction)(Math.π)/numReactions)))
}
